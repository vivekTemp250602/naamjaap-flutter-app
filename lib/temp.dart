...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // State variables are only for user preferences.
    ...
    return Stack(
      children: [
        ...
        Scaffold(
          ...
          body: SafeArea(
            // THIS IS THE CORRECTED LAYOUT: The StreamBuilder is now the parent of all content.
            child: StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                // All the UI is now built inside this safe builder.
                  ...
                  child: Column(
                    children: [
                      ...
                      if (!_isQuoteDismissedToday)
                        Dismissible(
                          // The 'userData' variable is now correctly in scope.
